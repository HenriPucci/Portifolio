...
export const MiroIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M17.4 4H15l2.4 4.8L13.2 4h-2.4l2.4 6L9 4H6.6l2.4 7.2L4.8 4H4v16h.8l4.2-10.8L6.6 20H9l4.2-12L9 20h2.4l4.2-13.2L13.2 20h2.4L18 8.8 15 20h2.4l2.4-8V4h-2.4z" fill="#050038" fillRule="evenodd"/>
  </svg>
);
